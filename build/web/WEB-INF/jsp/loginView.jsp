<%-- 
    Document   : loginView
    Created on : Aug 25, 2021, 2:17:29 PM
    Author     : Espi
--%>
                                ...
                                <div align="justify" style="color: #003366; font-size-adjust: 2; font-family: Veradana">
                                    ...
                                    <spring:nestedPath path="CUSTOMER">
                                        <form name="form1" method="post" action="">
                                            ...
                                            <tr bgcolor="#F7F6F2">
                                                <td width="139" height="135" valign="top">
                                            ...
                                            <tr bgcolor="#F7F6F2">
                                                <td>&nbsp;</td>
                                                <td><input type="submit" name="Submit" value="Login">&nbsp;&nbsp;<input type="reset" value="reset" value="Clear"></td>
                                            </tr>
                                            </table>
                                            </form>
                                    </spring:nestedPath>
