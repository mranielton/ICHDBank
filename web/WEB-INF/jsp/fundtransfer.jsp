<%-- 
    ...
    Created on : Aug 26, 2021, 10:34:17 AM
    Author     : Espi
--%>
                                     ...
                                     <spring:nestedPath path="transferaccount">
                                        <form name="form1" method="post" action="">
                                            ...
                                            <td colspan="2" height="25" valign="top" align="center">
                                                <p style="color: white; font-size-adjust: 2; font-family: Verdana, Arial, Helvetica, sans-serif">Transfer Fund   
                                                </p></td>
                                            </tr>
                                            <tr bgcolor="#F7F6F2">
                                                <td  height="36" valign="top">
                                                    <p style="color: #336699; font-size-adjust: 2; font-family: Verdana, Arial, Helvetica, sans-serif">TO Account Number
                                                    </p></td>
                                                <td valign="top">
                                                    <p> 
                                            ...
                                            <tr bgcolor="#F7F6F2">
                                                ...
                                                <td><input type="reset" value="reset" value="Clear"></td>
                                            </tr>
                                            </table>
                                            </form>
                                    </spring:nestedPath>
